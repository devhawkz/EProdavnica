using EProdavnica.Server.Migrations;
...
public class AuthService : IAuthService
{
    ...
    public async Task<ServiceResponse<bool>> PromenaLozinkeAsync(int korisnikId, string novaLozinka)
    {
        ...
        if (korisnik == null)
        {
            ...
            {
                Uspesno = false,
                Poruka = "Korisnik nije pronadjen."
            };
        }


        KreirajHashLozinke(novaLozinka, out byte[] lozinkaHash, out byte[] lozinkaSalt);
        ...
        return new ServiceResponse<bool> { Podaci = true, Poruka = "Lozinka je uspešno promenjena." };
    }
}